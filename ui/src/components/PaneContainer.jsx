...
export default function PaneContainer({
  ...
  return (
    <div
      ref={paneRef}
      className={cn(
        "flex flex-col h-full rounded-lg border transition-colors duration-200",
        className,
      )}
      style={{
    ...
    >
      {/* Pane Header */}
      <div
        className="flex items-center justify-between px-3 py-2 border-b shrink-0 relative z-20"
